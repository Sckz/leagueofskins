...
client.on('ready', () => {
    ...
    client.user.setActivity('LFL - PlayOffs', {
        type: "STREAMING",
...
client.on('messageCreate', async (msg) => {
    ...
    if (args[0] == "invite") {
        ...
        else if (args[1] == "12.15") {
            msg.channel.send("**__Patch 12.15 :__**\n\nhttps://leagueskins.go.yj.fr/patch/12-15")
        }
        else {
