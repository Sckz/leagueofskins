    ...
    if (args[0] == "event") {
        ...
        if (args[1] == "day1") {
            ...
            let m1 = new MessageEmbed()
             ...
             .setDescription('**__18h - BDSA <:VS:981456373957165068> LDLC OL__**\n\n*Votez en réagissant ci-dessous !*')
             .setColor("GOLD")
             .setTimestamp()
             .setFooter({text: client.user.username})
            ...
            let m2 = new MessageEmbed()
             ...
             .setTitle("LFL - Jour 1 Semaine 1")
             .setDescription('**__19h - GO <:VS:981456373957165068> Solary__**\n\n*Votez en réagissant ci-dessous !*')
             .setColor("WHITE")
             .setTimestamp()
             .setFooter({text: client.user.username})
            ...
            let m3 = new MessageEmbed()
             ...
             .setTitle("LFL - Jour 1 Semaine 1")
             .setDescription('**__20h - Misfits Premier <:VS:981456373957165068> GameWard__**\n\n*Votez en réagissant ci-dessous !*')
             .setColor("GOLD")
             .setTimestamp()
             .setFooter({text: client.user.username})
            ...
            .setTitle("LFL - Jour 1 Semaine 1")
            .setDescription('**__21h - Team Oplon <:VS:981456373957165068> Karmine Corp__**\n\n*Votez en réagissant ci-dessous !*')
            .setColor("WHITE")
            .setTimestamp()
            .setFooter({text: client.user.username})
           ...
           let m5 = new MessageEmbed()
            ...
            .setTitle("LFL - Jour 1 Semaine 1")
            .setDescription('**__22h - Vitality.Bee <:VS:981456373957165068> Mirage-Elyandra__**\n\n*Votez en réagissant ci-dessous !*')
            .setColor("GOLD")
            .setTimestamp()
            .setFooter({text: client.user.username})
        ...
        if (args[1] == "day2") {
            ...
            let m1 = new MessageEmbed()
             ...
             .setDescription('**__18h - Team GO <:VS:981456373957165068> Misfits Premier__**\n\n*Votez en réagissant ci-dessous !*')
             .setColor("GOLD")
             .setTimestamp()
             .setFooter({text: client.user.username})
            let s1 = await msg.channel.send({embeds: [m1]})
             s1.react('<:GO:981239610002796624>')
            ...
            let m2 = new MessageEmbed()
             ...
             .setTitle("LFL - Jour 2 Semaine 1")
             .setDescription('**__19h - BDSA <:VS:981456373957165068> Mirage-Elyandra__**\n\n*Votez en réagissant ci-dessous !*')
             .setColor("WHITE")
             .setTimestamp()
             .setFooter({text: client.user.username})
            let s2 = await msg.channel.send({embeds: [m2]})
            s2.react('<:BDSA:981239618882117732>')
            ...
            let m3 = new MessageEmbed()
             ...
             .setTitle("LFL - Jour 2 Semaine 1")
             .setDescription('**__20h - Karmine Corp <:VS:981456373957165068> GameWard__**\n\n*Votez en réagissant ci-dessous !*')
             .setColor("GOLD")
             .setTimestamp()
             .setFooter({text: client.user.username})
            let s3 = await msg.channel.send({embeds: [m3]})
            ...
            .setTitle("LFL - Jour 2 Semaine 1")
            .setDescription('**__21h - Vitality.Bee <:VS:981456373957165068> Solary__**\n\n*Votez en réagissant ci-dessous !*')
            .setColor("WHITE")
            .setTimestamp()
            .setFooter({text: client.user.username})
           let s4 = await msg.channel.send({embeds: [m4]})
           s4.react('<:VIT:981239650620416000>')
           s4.react('<:SLY:981239640310829056>')
